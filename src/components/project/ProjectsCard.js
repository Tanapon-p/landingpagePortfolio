...
export const ProjectsCard = ({ project }) => {
  ...
  return (
    <div
      className="flex flex-row flex-wrap items-center m-4  sm:m-6 bg-white border border-gray-200 
      sm:rounded-lg shadow duration-150 md:hover:scale-105 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
    >
      <div className="flex flex-col md:flex-row max-w-screen-xl ">
        <img
          className="w-full md:w-2/3 object-cover md:object-center rounded-t-lg md:rounded-none "
          src={image}
          alt={title}
        />
        <div className="flex flex-col justify-between p-4 leading-normal w-full">
          <h5 className="mb-2 text-xl sm:text-2xl font-medium tracking-tight text-gray-900 dark:text-white">
            {title}
          </h5>
          ...
          <div className="flex flex-row items-center justify-end ">
            {/* <a href={link} target="_blank" rel="noreferrer">
              <button
                type="button"
                className="h-12 text-sm flex items-center justify-center focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg  px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
              >
                <svg
